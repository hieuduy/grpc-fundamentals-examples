...
func request_CalculatorService_CalculateSum_0(ctx context.Context, marshaler runtime.Marshaler, client CalculatorServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq CalculateSumRequest
	...
	msg, err := client.CalculateSum(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_CalculatorService_CalculateSum_0(ctx context.Context, marshaler runtime.Marshaler, server CalculatorServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq CalculateSumRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := server.CalculateSum(ctx, &protoReq)
	return msg, metadata, err
...
func RegisterCalculatorServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server CalculatorServiceServer) error {
	...
	mux.Handle("POST", pattern_CalculatorService_CalculateSum_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_CalculatorService_CalculateSum_0(rctx, inboundMarshaler, server, req, pathParams)
		...
		forward_CalculatorService_CalculateSum_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterCalculatorServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client CalculatorServiceClient) error {
	...
	mux.Handle("POST", pattern_CalculatorService_CalculateSum_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_CalculatorService_CalculateSum_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_CalculatorService_CalculateSum_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"api", "calculator", "sum"}, "", runtime.AssumeColonVerbOpt(true)))
)

var (
	forward_CalculatorService_CalculateSum_0 = runtime.ForwardResponseMessage
)
